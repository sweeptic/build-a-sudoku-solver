...
suite('UnitTests', () => {
  ...
  test('UnitTests Logic handles a valid puzzle string of 81 characters ', () => {
  ...
  test('UnitTests Logic handles a puzzle string with invalid characters (not 1-9 or .) ', () => {
  ...
  test('UnitTests Logic handles a puzzle string that is not 81 characters in length ', () => {
  ...
  test('UnitTests Logic handles a valid row placement ', () => {
  ...
  test('UnitTests Logic handles a invalid row placement ', () => {
  ...
  test('UnitTests Logic handles a valid column placement ', () => {
  ...
  test('UnitTests Logic handles a invalid column placement ', () => {
  ...
  test('UnitTests Logic handles a valid region (3x3 grid) placement ', () => {
  ...
  test('UnitTests Logic handles a invalid region (3x3 grid) placement ', () => {
  ...
  test('UnitTests Valid puzzle strings pass the solver ', () => {
  ...
  test('UnitTests Invalid puzzle strings fail the solver ', () => {
  ...
  test('UnitTests Solver returns the the expected solution for an incomplete puzzle ', () => {
